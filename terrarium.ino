...
// const char* WIFI_SSID = "PiotrK";
// const char* WIFI_PASS = "7EE9EJYTG3MR";
...
// // co ile wysyłać metryki
// const unsigned long SEND_EVERY_MS = 10UL * 60UL * 500UL;  // 5 minut
...
//   unsigned long remaining_s  = (remaining_ms + 999UL) / 1000UL; // zaokrąglenie w górę
...
//   // --- wysyłka metryk ---
//   if (millis() - last_send_ms >= SEND_EVERY_MS) {
//     if (WiFi.status() != WL_CONNECTED) {
//       connectWifi();
//     }
...
// Piny (zmień, jeśli kolidują z Twoją płytką)
const int IN1 = 13;  // D13  (UWAGA: GPIO12 jest strapem boot — u nas go nie używamy)
const int IN2 = 12;  // D12  (strap: jeśli miałbyś problemy z bootem, zamień na 25/26/33/32)
...
void loop() {
  ...
  // === uruchom jedną „iterację” logiki silnika ===
  runStepperOnce();  // zawiera własne krótkie opóźnienia (kroki + postój na pustym)
}
